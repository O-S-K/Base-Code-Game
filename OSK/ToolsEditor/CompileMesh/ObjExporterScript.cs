...
// export mesh or gameobject in Asset/Export wave
...
public static class ObjExporterScript
{
    ...
    [MenuItem("Assets/Export Model (No Submeshes)")]
    ...
    static string processTransform(Transform transform, bool makeSubmeshes)
    {
        ...
        if (mf) meshString.Append(ObjExporterScript.MeshToString(mf, transform));

...
public class CutMeshDestroyed : MonoBehaviour
{
    ...
    void Update()
    {
        // add script to Object call DestroyMesh();
    ...
    private void DestroyMesh()
    {
        ...
        for (var c = 0; c < CutCascades; c++)
        {
            for (var i = 0; i < parts.Count; i++)
            {
                ...
                var plane = new Plane(
                    Random.onUnitSphere, new Vector3(Random.Range(bounds.min.x, bounds.max.x),
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(CutMeshDestroyed original)
        {
            ...
            var meshDestroy = GameObject.AddComponent<CutMeshDestroyed>();
